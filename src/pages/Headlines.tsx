...
import { 
  useControleProducao, 
  useCreateControleProducao, 
  useUpdateControleProducao, 
  useDeleteControleProducao 
} from "@/hooks/useControleProducao";
...
const Headlines = () => {
  ...
  const { data: controleProducao, isLoading: isLoadingControle } = useControleProducao();
                ...
                <div className="space-y-4 mt-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        type="date"
                        value={controleData}
                        onChange={(e) => setControleData(e.target.value)}
                      />
                    </div>
                    <div>
                      <Label htmlFor="controle-mentorado">Mentorado *</Label>
                      <Input
                        id="controle-mentorado"
                        value={controleMentorado}
                        onChange={(e) => setControleMentorado(e.target.value)}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        id="controle-quantidade"
                        value={controleQuantidade}
                        onChange={(e) => setControleQuantidade(e.target.value)}
                        placeholder="Ex: 5 roteiros"
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        id="controle-horas"
                        value={controleHoras}
                        onChange={(e) => setControleHoras(e.target.value)}
                        placeholder="Ex: 8h"
                      />
                    </div>
                  </div>
                  <div>
                    ...
                    <Input
                      id="controle-plataformas"
                      value={controlePlataformas}
                      onChange={(e) => setControlePlataformas(e.target.value)}
                  ...
                  <div>
                    ...
                    <Input
                      id="controle-dificuldades"
                      value={controleDificuldades}
                      onChange={(e) => setControleDificuldades(e.target.value)}
                    ...
                    <TableCell>
                      <div className="flex gap-1">
                        <Button 
                          variant="ghost" 
                          size="icon"
                          onClick={() => openEditControle(registro)}
                        >
                          <Pencil className="h-4 w-4" />
                        </Button>
                        <Button 
                          variant="ghost" 
                          size="icon"
                          onClick={() => deleteControle.mutate(registro.id)}
                        >
                          <Trash2 className="h-4 w-4 text-destructive" />
                        </Button>
                      </div>
