...
const Perfil = () => {
  ...
  const getProgressPercentage = (cargo: 'junior' | 'pleno' | 'senior') => {
    switch(cargo) {
      case 'junior': return 33;
      case 'pleno': return 66;
  ...
  const progressPercentage = getProgressPercentage(cargoValue);
          ...
          <TabsContent value="perfil" className="space-y-8 mt-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-8">
                ...
                {/* Meus Cases */}
                <div className="space-y-4">
                  <h3 className="text-lg font-semibold">Meus cases</h3>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {[1, 2, 3].map((i) => (
                      <Card 
                        key={i} 
                        className="h-48 flex items-center justify-center border-2 border-dashed border-border bg-muted/20"
                      >
                        <p className="text-muted-foreground text-sm">Case {i}</p>
                      </Card>
                    ))}
                  </div>
                </div>
              ...
              <div className="flex flex-col items-center gap-6 p-6">
                ...
                <div className="text-center space-y-2">
                  ...
                  <p className="text-xl text-orange-500">
                    Cargo: {profile?.cargo ? capitalize(profile.cargo) : 'Junior'}
                  </p>
                </div>
              </div>
            </div>
